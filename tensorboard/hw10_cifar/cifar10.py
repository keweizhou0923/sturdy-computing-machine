...
from hw10_cifar import cifar10_input
...
tf.app.flags.DEFINE_string('data_dir', 'C:\\Users\\KZ26677\\Downloads\\cifar_tmp\\cifar10_data',
...
def inference(images):
  ...
  with tf.variable_scope('conv6') as scope:
    ...
    # pool3
    pool3 = tf.nn.max_pool(conv6, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1],
                         padding='SAME', name='pool3') 
    # norm4
    norm4 = tf.nn.lrn(pool3, 4, bias=1.0, alpha=0.001 / 9.0, beta=0.75,
                    name='norm4')
